...
export default function LogoIcone({h, w}) {
    return (
    <SvgIcon sx={{ height: h, width: w, mr: 2, maxWidth: '100px', minWidth: '78px', minHeight: '37px' }}>
        <svg id="LOGO"
            width={h}
            height={w} 
            viewBox="0 0 100 51"
        ...
        <defs>
            <clipPath id="clip-path">
                <rect id="Retângulo_803" 
                    data-name="Retângulo 803" 
                    width={100} 
                    height={51}	 
                    fill="none"/>
            </clipPath>
